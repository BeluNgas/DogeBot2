...
if(isButton == 'igm'){
reply('https://github.com/BeluNgas')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel/UCOIWspCK8CIaWfF59CQXtag')
}
...
await alpha.sendMessage(from, menuu, MessageType.buttonsMessage, {quoted: ftex})
		break
case 'test':
reply(`BOT WAS ONLINE BEFORE YOUR BIRTH WKWK😏`)
break
//FunMenu
case 'stupid':
      case 'foolish':
